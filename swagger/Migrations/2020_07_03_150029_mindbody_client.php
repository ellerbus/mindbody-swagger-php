...
class MindBodyClient extends Migration
{
	...
	public function up()
	{
		Schema::create('mindbody_client', function (Blueprint $table)
		{
			...
			$table->CustomClientFieldValue[]('custom_client_fields');
			$table->ClientCreditCard('client_credit_card');
			$table->AssignedClientIndex[]('client_indexes');
			$table->ClientRelationship[]('client_relationships');
			...
			$table->ProspectStage('prospect_stage');
